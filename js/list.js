...
{
	id: 'oil_filter_kolbenschmidt', title: 'Kolbenschmidt', type: 'Фільтр масляний', cat: { car: 1, },
	keyval: [
		
		{ k: 'Фільтр масляний' 		, v: 'Kolbenschmidt' 	, },
		{ k: 'модель' 				, v: '50 013 073' 		, },
		{ backspace: true },

		{ k: 'продавець' 		, v: 'Лоск 2/4' 		, gps: '', }, // кіоск в супермаркеті Чудо
	],
},
